...
client.on("message", async message => {
  ...
  if(message.content == `<@!${client.user.id}>`){
    ...
    .setColor("#7289DA")
    .setDescription(`Hello my friend! My prefix is: "!"\nIf you need a help: https://discord.gg/DfzxGR3`)
    .setFooter("Guard BOT! | Always Service!", client.user.avatarURL)
    ...
    const embed = new Discord.RichEmbed()
    .setColor("#7289DA")
    .setDescription(`Merhaba arkadaşım! Benim ön-ek'im: "!"\nEğer yardıma ihtiyacın varsa: https://discord.gg/DfzxGR3`)
    .setFooter("Guard BOT! | Daima Hizmet!", client.user.avatarURL)
    message.channel.send(embed)
    return;
    } else return;
  }
